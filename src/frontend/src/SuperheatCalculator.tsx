...
interface SuperheatCalculatorProps {
  onBack: () => void;
}

function getSuperheatStatus(superheat: number): {
  color: string;
  bgColor: string;
  borderColor: string;
  label: string;
  ...
  if (superheat < 5) {
    return {
      ...
      label: "Low",
      message: "Low superheat \u2014 possible overfeeding or floodback risk",
    };
  }
  if (superheat <= 20) {
    return {
  ...
  return {
    ...
    label: "High",
    message: "High superheat \u2014 possible underfeeding or low charge",
  };
}

export default function SuperheatCalculator({
  onBack,
}: SuperheatCalculatorProps) {
  ...
  const status = superheat !== null ? getSuperheatStatus(superheat) : null;
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          <Button
            ...
            onClick={onBack}
            data-ocid="superheat.back_button"
          >
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
            ...
            <CardContent className="py-6 px-5 space-y-4">
              {!hasValidInputs && (
                <p className="text-sm text-muted-foreground text-center py-2">
                  Enter suction pressure and line temp to calculate
                </p>
              )}
              ...
              {hasValidInputs && satTemp !== null && (
                <>
                  ...
                  {/* Superheat Result \u2014 most prominent */}
                  {superheat !== null && status && (
                    <div
                      ...
                      data-ocid="superheat.success_state"
                    >
                      <div>
                        <p
        ...
        {outsideOperatingRange && satTemp !== null && (
          <motion.div
            ...
            data-ocid="superheat.warning_state"
          >
        ...
        {status && superheat !== null && (
          <motion.div
            ...
            data-ocid="superheat.loading_state"
          >
            <TriangleAlert
        ...
        {outOfRange && psi !== null && (
          <motion.div
            ...
            data-ocid="superheat.error_state"
          >
        ...
        <Card className="border border-border">
          <CardContent className="py-4 px-5">
            ...
            <ol className="text-sm text-muted-foreground space-y-1.5 list-decimal list-inside">
              ...
              <li>Enter the suction pressure (low-side gauge reading)</li>
              <li>
                Enter the suction line temperature (measured at the service
                valve)
              </li>
              <li>Superheat = Line Temp \u2212 Saturation Temp</li>
            </ol>
            <p className="text-xs text-muted-foreground mt-3 italic">
              Typical superheat for a fixed-orifice system: 10\u201318\u00b0F.
              TXV systems: 8\u201312\u00b0F.
            </p>
          </CardContent>
        </Card>
